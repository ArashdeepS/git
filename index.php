...
<html>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#home">ArashdepS</a>
    </div>
    <ul class="nav navbar-nav">
      ...
      <li><a href="#">Page 3</a></li> 
        ...
        <div id="#home">
            ...
            <div align="center"><h1 font-size="70">Cyber Office</h1></div>
            <div align="center"><h3>Brings You Easy Way Of How To</h3></div>
            </div>
            </div>
        </div>
        <div id="#page2">
